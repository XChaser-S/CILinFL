...
class Network(object):
    ...
    def __init__(self, dropout, image_shape, is_training=True):
...
def load_imitation_learning_network(input_image, input_data, input_size, dropout, is_training=True):
    branches = []

    x = input_image

    network_manager = Network(dropout, tf.shape(x), is_training=is_training)
